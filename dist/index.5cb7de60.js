...
var _tricksJs = require("./Tricks.js");
var _tricksJsDefault = parcelHelpers.interopDefault(_tricksJs);
let selected = [];
...
function renderCard(card) {
    ...
    element.classList.add(`card${_cardJsDefault.default.SUITS[card.suit]}${_cardJsDefault.default.VALUES[card.val]}`);
...
function getTrick() {
    try {
        let cardArr = selected.map((x)=>new _cardJsDefault.default(x)
        );
        return new _tricksJsDefault.default(cardArr);
    } catch (err) {
        return null;
    }
}
let deckArr = _cardJsDefault.default.generateDeck();
deckArr.forEach(renderCard);

},{"./Card.js":"8bfrz","./Tricks.js":"5l9Dt","@parcel/transformer-js/src/esmodule-helpers.js":"JacNc"}],"8bfrz":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{}],"5l9Dt":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class Trick {
    static singleCard = 0;
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"JacNc"}]},["8Ye98","6cF5V"], "6cF5V", "parcelRequire2e22")
